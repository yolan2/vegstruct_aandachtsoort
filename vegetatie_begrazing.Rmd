...
template <- rast("C:/Users/yolan/OneDrive/Documenten/UGENT/Master/Stage/hoogtemetrieken/grazing_diff_norm_period_03_09.tif")
...
density = file.path(grazing_folder, "grazing_diff_norm_period_03_09.tif")
# 1. load classe predictors
cls_files   <- c(list.files(veg_ras_folder, pattern="\\.tif$", full.names=TRUE), density = density)
