...
GRAZING DENSITY: Hier wordt de begrazingsdata ingeladen en geagregeerd tot op 25x25m. Een correcte filtering van deze data dient nog te gebeuren!!!

```{r}
chm_ras25m <- aggregate(chm_ras1, fact = 25 / res(chm_ras1), fun = mean)
...
# Rasterize: count number of points per 5x5 m cell aligned with chm_ras5
grazing_density <- rasterize(data_westhoek, chm_ras25m, fun = "count", background = 0)

# Plot to verify
plot(grazing_density, main = "Begrazingsdichtheid (5m raster)")
```
